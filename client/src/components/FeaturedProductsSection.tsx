  ...
  const featuredProducts: FeaturedProduct[] = [
    {
      ...
      model: "No.GT-NS20A",
      description:
        "Mayor fuerza de presión en un 20%. Recomendado para equipos más ligeros y pequeños. La posición de entrada de aire se puede ajustar 180 grados según la posición de montaje.",
      specs: [
    ...
    },
    {
      ...
      model: "No.GT-NS30A",
      description:
        "Mayor fuerza de presión en un 50%. Recomendado para equipos más ligeros y pequeños. La posición de entrada de aire se puede ajustar 180 grados según la posición de montaje.",
      specs: [
    ...
    },
    {
      ...
      model: "No.GT-N20",
      description:
        "Para corte o engarzado de resinas o metales. Las cuchillas fabricadas a medida por VESSEL proporcionan soluciones para una gama prácticamente ilimitada de necesidades.",
      specs: [
    ...
    },
    {
      ...
      model: "No.GT-NL30",
      description:
        "Alicate neumático ideal para trabajos manuales de corte. Para corte de plástico y acero, o para trabajos de engarzado. Con cuchillas fabricadas a medida, la gama de aplicaciones es infinita.",
      specs: [
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <h2 className="font-montserrat font-bold text-3xl md:text-4xl lg:text-5xl mb-4 text-black">
            Alicates y Tijeras Neumáticas
          </h2>

          <div className="w-24 h-0.5 bg-vessel-red mx-auto mt-4 mb-8"></div>

          <p className="max-w-3xl mx-auto text-lg text-gray-600">
            Alicates Neumáticos, Tijeras Neumáticas, y más. Herramientas
            profesionales de alta precisión para corte y engarzado.
          </p>
        </motion.div>
              ...
              <div className="flex flex-col md:flex-row h-full">
                ...
                <div className="md:w-3/5 p-6 bg-white flex flex-col">
                  <div className="mb-2">
                    ...
                    <p className="text-vessel-red font-medium">
                      {product.model}
                    </p>
                  </div>
                  ...
                  <div className="mb-4 flex-grow">
                    <ul className="space-y-1">
                      {product.specs.map((spec, i) => (
                        ...
                        >
                          <span className="text-vessel-red mr-2 text-xs">
                            ■
                          </span>
                          {spec}
                        </li>
