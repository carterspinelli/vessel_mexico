...
export default function HeroSection() {
  return (
    <section id="home" className="pt-40 pb-40 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 flex flex-col items-center text-center relative z-10">
        ...
        >
          <h1 className="font-montserrat font-bold text-4xl md:text-5xl lg:text-6xl mb-6 leading-tight text-white">
            Herramientas de <span className="text-vessel-red">Precisión </span>
          </h1>
          <p className="text-lg md:text-xl mb-12 text-white/90 max-w-2xl mx-auto">
            Desde 1916, Vessel ha sido líder en herramientas de fijación,
            ofreciendo calidad y precisión excepcionales para profesionales.
          </p>
